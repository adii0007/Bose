	...
	<center>
		...
		<form action="<%=ORSView.GET_MARKSHEET_CTL%>" method="post">
			...
			<table>
				...
				<input style="width: 200px; padding: 3px;" type="text" name="rollNo"
					placeholder="Enter Roll Number" value=""> &emsp;
				<input style="width: 30px; padding: 2px;" type="submit"
					name="operation" value="<%=GetMarksheetCtl.OP_GO%>"> &nbsp;
				<input style="width: 50px; padding: 2px;" type="submit"
					name="operation" value="<%=GetMarksheetCtl.OP_RESET%>">
				<br>
