        ...
        <center>
            ...
            <table align="center" style="margin-left:40% ">
                <tr>
                    ...
                    <td><input style="width: 200px; padding: 5px;" type="text" name="name" placeholder="Enter Name"
                        value="<%=DataUtility.getStringData(bean.getName())%>"><font
                        color="red"> <%=ServletUtility.getErrorMessage("name", request)%></font></td>
                </tr>
                <tr>
                    <th align="left">Description<font style="color: red">*</font></th>
                    <td><input style="width: 200px; padding: 5px;" type="text" name="description" placeholder="Enter Description"
      ...
      %>
				...
				<tr>
					...
					<td><input style="width: 90px; padding: 2px;" type="submit" name="operation"
						value="<%=RoleCtl.OP_UPDATE%>"> &nbsp;<input style="width: 90px; padding: 2px;" type="submit"
						name="operation" value="<%=RoleCtl.OP_CANCEL%>"> <%}else{ %>
				<tr>
					<th></th>
					<td><input style="width: 90px; padding: 2px;" type="submit" name="operation"
