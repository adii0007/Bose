                 ...
                 <tr>
              	...
              	<tr>
						...
						<td><input type="submit" name="operation"
							value="<%=(bean.getId()<=0)?SubjectCtl.OP_SAVE:SubjectCtl.OP_UPDATE%>" style="width: 90px; padding:2px"> 
							<input type="submit" name="operation"
							value="<%=(bean.getId()>0) ? SubjectCtl.OP_CANCEL : SubjectCtl.OP_RESET%>" style="width: 90px; padding:2px"></td>
					</tr>
				</table>
