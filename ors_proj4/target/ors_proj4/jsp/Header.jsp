...
<body><%
	...
	<table width="100%">
		...
		<tr>
			<td width="60%"><a href="<%=ORSView.WELCOME_CTL%>">Welcome</b></a> |
				<%
				if (userLoggedIn) {
			%> <a
 ...
 %></td>
			<td rowspan="2">
				<h1 align="Right">
					<img src="<%=ORSView.APP_CONTEXT%>/img/customLogo.jpg" width="200"
						height="60">
				</h1>
			</td>
		...
		%><tr style="width: 100%">
			...
			%> <a href="<%=ORSView.USER_CTL%>">Add User</b></a> | <a
				...
				href="<%=ORSView.MARKSHEET_LIST_CTL%>">Marksheet List</a> | <%
 	}
 %> &emsp;<a href="<%=ORSView.GET_MARKSHEET_CTL%>">Get Marksheet</b></a> | <a
