		...
		<input type="hidden" name="modifiedDatetime"
			...
			<table align="center" style="margin-left:40%">
				...
				<tr>
					...
					<td><input type="text" name="description"placeholder="Description Of Course"
			...
			<tr>
						...
						<td><input type="submit" name="operation"
							value="<%=(bean.getId()<=0)?CourseCtl.OP_SAVE:CourseCtl.OP_UPDATE%>" style="width: 90px; padding:2px"> 
							<input type="submit" name="operation"
							value="<%=(bean.getId()>0) ? CourseCtl.OP_CANCEL : CourseCtl.OP_RESET%>" style="width: 90px; padding:2px"></td>
					</tr>
				</table>
