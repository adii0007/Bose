        ...
        <center>
            ...
            <table align="center" style="margin-left:40% ">
                <tr>
                    ...
                    <td><input style="width: 200px; padding: 3px;" type="text" name="login"
                ...
                <tr>
                    ...
                    <td><input style="width: 200px; padding: 3px;" type="text" name="firstName"
                ...
                <tr>
                    ...
                    <td><input style="width: 200px; padding: 3px;" type="text" name="lastName"
                ...
                <tr>
                    ...
                    <td><input style="width: 200px; padding: 3px;" type="text" name="mobileNo"
                ...
                <tr>
                    ...
                    <td><input style="width: 200px; padding: 3px;" type="text" name="dob" id="datepicker" readonly="readonly" 
                ...
                <tr>
                <td></td>
                    <td><input style="padding: 2px; width: 125px;" type="submit" name="operation"
                        value="<%=MyProfileCtl.OP_CHANGE_MY_PASSWORD %>">  
                        <input style="padding: 2px; width: 70px;" type="submit" name="operation" 
