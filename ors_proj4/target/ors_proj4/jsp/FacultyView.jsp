			...
			<table class="t1">
				...
				<table align="center" style="margin-left:39% ">
					<tr>
						...
						<td><input style="width: 200px; padding: 5px;" type="text" name="firstName" placeholder="Enter First Name"
							value="<%=DataUtility.getStringData(bean.getFirstName())%>"><font
							color="red"> <%=ServletUtility.getErrorMessage("firstName", request)%></font></td>
					</tr>
					<tr>
						<th align="left">Last Name<font color="red">*</font></th>
						<td><input style="width: 200px; padding: 5px;" type="text" name="lastName" size="26" placeholder="Enter Last Name"
					...
					<tr>
						...
						<td><input style="width: 200px; padding: 5px;" type="text" name="qualification" size="26" placeholder="Enter Qualification"
					...
					<tr>
						...
						<td><input style="width: 200px; padding: 5px;" type="text" name="emailId" size="26" placeholder="Enter Email-Id"
					...
					<tr>
						...
						<td><input style="width: 200px; padding: 5px;" type="text" name="mobNo" size="26" placeholder="Enter Contact No"
					...
					<tr>
						...
						<td><input style="width: 200px; padding: 5px;" type="text" name="dob" 
					...
					<tr>
						<td></td>
						<td><input style="width: 99px; padding:2px" type="submit" name="operation"
							value="<%=(bean.getId() > 0) ? FacultyCtl.OP_UPDATE : UserCtl.OP_SAVE%>">
							<input style="width: 97px; padding:2px" type="submit" name="operation"
