...
public class MarksheetCtl extends BaseCtl {
    ...
    protected boolean validate(HttpServletRequest request) {
        ...
        if (DataValidator.isNull(request.getParameter("physics"))) {
        	...
        	request.setAttribute("physics", "Mark can not be less than 0");
        	pass =false;
        }
    	...
    	request.setAttribute("chemistry", "Mark can not be less than 0");
    	pass =false;
    }
        ...
        if (DataValidator.isNull(request.getParameter("maths"))) {
        	...
        	request.setAttribute("maths", "Mark can not be less than 0");
        	pass =false;
        }
