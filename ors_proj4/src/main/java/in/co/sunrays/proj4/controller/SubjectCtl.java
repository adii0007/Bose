...
public class SubjectCtl extends BaseCtl {
	...
	protected boolean validate(HttpServletRequest request) {
		...
		if (DataValidator.isNull(request.getParameter("name"))) {
			...
			pass = false;
		}else if (!DataValidator.isSubject(request.getParameter("name"))) {
			request.setAttribute("name", "Invaild subject name");
			pass = false;
		}
		...
		if (DataValidator.isNull(request.getParameter("description"))) {
			...
			pass = false;
			/*
			 * }else if (!DataValidator.isDescription(request.getParameter("description")))
			 * { request.setAttribute("description",
			 * PropertyReader.getValue("error.description", "")); pass = false;
			 */
		}
