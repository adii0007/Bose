...
public class UserModel {
	 ...
	 * conn.rollback(); } catch (Exception ex) { ex.printStackTrace(); throw new
	 * ApplicationException( "Exception : add rollback exception " +
	 * ex.getMessage()); } throw new
	 * ApplicationException("Exception : Exception in add User"); } finally {
	 * JDBCDataSource.closeConnection(conn); } log.debug("Model add End"); return
	 * pk; }
	 */
	/**
	 * Delete a User
	...
	public boolean forgetPassword(String login) throws ApplicationException, RecordNotFoundException, MessagingException {
