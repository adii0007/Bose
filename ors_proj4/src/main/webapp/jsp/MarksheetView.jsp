        ...
        <center>
            ...
            <table align="center" style="margin-left:40% ">
                <tr>
                    ...
                    <td><input style="width: 200px; padding: 5px;" type="text" name="rollNo" placeholder="Enter Roll Number"
                ...
                <tr>
                    ...
                    <td><input style="width: 200px; padding: 5px;" type="text" name="physics" placeholder="Enter Physics Marks" 
                ...
                <tr>
                    ...
                    <td><input style="width: 200px; padding: 5px;" type="text" name="chemistry" placeholder="Enter Chemistry Marks"
                ...
                <tr>
                    ...
                    <td><input style="width: 200px; padding: 5px;" type="text" name="maths" placeholder="Enter Maths Marks"
                ...
                <tr>
                    ...
                    <td><input type="submit" name="operation"
                        ...
                        value="<%=(bean.getId()>0) ? MarksheetCtl.OP_CANCEL : MarksheetCtl.OP_RESET%>" style="width: 97px;"></td>
                </tr>
            </table>
        </form>
