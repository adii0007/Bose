...
public class RoleModelTest {
    ...
    public static void testUpdate() {
        ...
        try {
            ...
            bean.setName("Khoshbu");
            bean.setDescription("Savant");
            model.update(bean);

            RoleBean updatedbean = model.findByPK(6L);
            if (!"Khoshbu".equals(updatedbean.getName())) {
